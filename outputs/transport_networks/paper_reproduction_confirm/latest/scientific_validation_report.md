...
Generated at UTC: 2026-04-22T00:39:35.936565+00:00
Profile: `confirm`
...
- Open signatures: 1152.
- Group-split combined accuracy: 0.000.
- Group-split baseline accuracy: 0.000.
- Classical-only group accuracy: 0.000.
- Mean strongest dephasing gain: 0.172.
- Strong-effect criterion met: True.
- Scientific verdict: `exploratory_only`.

## Paper reproduction score

- Matched: ['Mohseni/Plenio/Rebentrost: nonzero dephasing can improve target arrival.', 'Mohseni/Plenio/Rebentrost: high dephasing suppression appears after the optimum.'].
- Failed: ['Razzoli: target/trap placement did not change efficiency above threshold.'].
- Uncertain: ['Mulken/Blumen: topology dependence in closed-walk return was weak in this grid.'].
...
Refine `modular_two_community + unweighted + near target` with the confirm profile only if group-split and classical-control criteria remain positive in pilot mode.
