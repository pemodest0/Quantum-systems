...
- Maior spread por trocar alvo: `0.446`.
- Efeito forte de alvo pelo critério CI95 > 0.05: `True`.
- Diferença média quântico - clássico: `0.101`.
- Casos quantum_advantage_like: `1256`.
- Classificação combinada reaproveitada: `0.615`.
- Validação numérica passou: `True`.
