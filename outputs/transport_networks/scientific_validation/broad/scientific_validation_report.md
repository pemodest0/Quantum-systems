...
Generated at UTC: 2026-04-21T11:56:37.913884+00:00
Profile: `broad`
...
- Group-split baseline accuracy: 0.133.
- Classical-only group accuracy: 0.183.
- Mean strongest dephasing gain: 0.263.
- Strong-effect criterion met: True.
- Scientific verdict: `strong_candidate`.
...
Refine `random_geometric + exponential_distance + near target` with the confirm profile only if group-split and classical-control criteria remain positive in pilot mode.
